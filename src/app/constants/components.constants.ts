export enum ComponentEnum {
  ...
  dropdownToggle = 'Desplegable',
  dropdownIcon = 'Desplegable con icono'
}
...
export const COMPONENTS_NAVIGATION = [
  ...
  },
  {
    ...
    navElements: [
      {
        title: 'Desplegable',
        route: '/components/dropdown/dropdown-toggle'
      },
      {
        title: 'Desplegable con icono',
        route: '/components/dropdown/dropdown-icon'
      }
    ]
  }
];
